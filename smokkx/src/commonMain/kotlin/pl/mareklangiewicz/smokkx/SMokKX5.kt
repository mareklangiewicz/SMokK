...
class SMokKX5<A1, A2, A3, A4, A5, T>(var autoCancel: Boolean = false, var autoResume: (suspend (A1, A2, A3, A4, A5) -> T)? = null) : Continuation<T> {
...
fun <A1, A2, A3, A4, A5, T> smokkx(autoCancel: Boolean = false, autoResume: (suspend (A1, A2, A3, A4, A5) -> T)? = null) = SMokKX5<A1, A2, A3, A4, A5, T>(autoCancel, autoResume)
