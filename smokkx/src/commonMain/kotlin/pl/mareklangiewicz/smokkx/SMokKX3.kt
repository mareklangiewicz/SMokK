...
class SMokKX3<A1, A2, A3, T>(var autoCancel: Boolean = false, var autoResume: (suspend (A1, A2, A3) -> T)? = null) :
  Continuation<T> {
...
fun <A1, A2, A3, T> smokkx(autoCancel: Boolean = false, autoResume: (suspend (A1, A2, A3) -> T)? = null) =
  SMokKX3<A1, A2, A3, T>(autoCancel, autoResume)
