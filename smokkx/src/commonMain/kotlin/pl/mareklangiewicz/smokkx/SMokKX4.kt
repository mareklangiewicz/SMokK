...
class SMokKX4<A1, A2, A3, A4, T>(
  var autoCancel: Boolean = false,
  var autoResume: (suspend (A1, A2, A3, A4) -> T)? = null,
) : Continuation<T> {
...
fun <A1, A2, A3, A4, T> smokkx(autoCancel: Boolean = false, autoResume: (suspend (A1, A2, A3, A4) -> T)? = null) =
  SMokKX4<A1, A2, A3, A4, T>(autoCancel, autoResume)
