...
class SMokKX7<A1, A2, A3, A4, A5, A6, A7, T>(
  var autoCancel: Boolean = false,
  var autoResume: (suspend (A1, A2, A3, A4, A5, A6, A7) -> T)? = null,
) : Continuation<T> {
...
fun <A1, A2, A3, A4, A5, A6, A7, T> smokkx(
  autoCancel: Boolean = false,
  autoResume: (suspend (A1, A2, A3, A4, A5, A6, A7) -> T)? = null,
) = SMokKX7<A1, A2, A3, A4, A5, A6, A7, T>(autoCancel, autoResume)
