...
class SMokK5<A1, A2, A3, A4, A5, T>(var invocationCheck: (A1, A2, A3, A4, A5) -> Boolean = { _, _, _, _, _ -> true }) : Continuation<T> {
    ...
    suspend fun invoke(arg1: A1, arg2: A2, arg3: A3, arg4: A4, arg5: A5): T {
        if (!invocationCheck(arg1, arg2, arg3, arg4, arg5)) throw SMokKException("SMokK5 fail for args: $arg1, $arg2, $arg3, $arg4, $arg5")
...
fun <A1, A2, A3, A4, A5, T> smokk(invocationCheck: (A1, A2, A3, A4, A5) -> Boolean = { _, _, _, _, _ -> true }) = SMokK5<A1, A2, A3, A4, A5, T>(invocationCheck)
