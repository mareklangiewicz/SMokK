...
class SMokK7<A1, A2, A3, A4, A5, A6, A7, T>(var invocationCheck: (A1, A2, A3, A4, A5, A6, A7) -> Boolean = { _, _, _, _, _, _, _ -> true }) : Continuation<T> {
    ...
    suspend fun invoke(arg1: A1, arg2: A2, arg3: A3, arg4: A4, arg5: A5, arg6: A6, arg7: A7): T {
        if (!invocationCheck(arg1, arg2, arg3, arg4, arg5, arg6, arg7)) throw SMokKException("SMokK7 fail for args: $arg1, $arg2, $arg3, $arg4, $arg5, $arg6, $arg7")
...
fun <A1, A2, A3, A4, A5, A6, A7, T> smokk(invocationCheck: (A1, A2, A3, A4, A5, A6, A7) -> Boolean = { _, _, _, _, _, _, _ -> true }) = SMokK7<A1, A2, A3, A4, A5, A6, A7, T>(invocationCheck)
