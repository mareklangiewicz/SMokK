...
class SMokK6<A1, A2, A3, A4, A5, A6, T>(var invocationCheck: (A1, A2, A3, A4, A5, A6) -> Boolean = { _, _, _, _, _, _ -> true }) :
  Continuation<T> {
  ...
  suspend fun invoke(arg1: A1, arg2: A2, arg3: A3, arg4: A4, arg5: A5, arg6: A6): T {
    ...
    ) throw SMokKException("SMokK6 fail for args: $arg1, $arg2, $arg3, $arg4, $arg5, $arg6")
...
fun <A1, A2, A3, A4, A5, A6, T> smokk(invocationCheck: (A1, A2, A3, A4, A5, A6) -> Boolean = { _, _, _, _, _, _ -> true }) =
  SMokK6<A1, A2, A3, A4, A5, A6, T>(invocationCheck)
