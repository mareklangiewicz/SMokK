...
class SMokK4<A1, A2, A3, A4, T>(var invocationCheck: (A1, A2, A3, A4) -> Boolean = { _, _, _, _ -> true }) :
  Continuation<T> {
  ...
  suspend fun invoke(arg1: A1, arg2: A2, arg3: A3, arg4: A4): T {
    ...
    ) throw SMokKException("SMokK4 fail for args: $arg1, $arg2, $arg3, $arg4")
...
fun <A1, A2, A3, A4, T> smokk(invocationCheck: (A1, A2, A3, A4) -> Boolean = { _, _, _, _ -> true }) =
  SMokK4<A1, A2, A3, A4, T>(invocationCheck)
